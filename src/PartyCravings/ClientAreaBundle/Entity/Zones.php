 ...
 * @ORM\Entity(repositoryClass="PartyCravings\ClientAreaBundle\Repository\ZonesRepository")
 */
class Zones
{
    /**
    ...
    /**
    * @ORM\OneToOne(targetEntity="PartyCravings\ClientAreaBundle\Entity\ZoneDescriptions", inversedBy="zoneId")
