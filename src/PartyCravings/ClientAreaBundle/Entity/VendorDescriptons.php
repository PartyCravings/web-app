 ...
 * @ORM\Entity(repositoryClass="PartyCravings\ClientAreaBundle\Repository\VendorDescriptonsRepository")
 */
class VendorDescriptons
{
    ...
    /**
     * @var int
     * @ORM\OneToOne(targetEntity="PartyCravings\ClientAreaBundle\Entity\Vendors", mappedBy="vendorDescription")
     */
    private $vendorId;
