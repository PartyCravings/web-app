 ...
 * @ORM\Entity(repositoryClass="PartyCravings\ClientAreaBundle\Repository\serviceOptionDescriptionsRepository")
 */
class ServiceOptionDescriptions
{
     ...
     * @var int
     *
     * @ORM\OneToOne(targetEntity="PartyCravings\ClientAreaBundle\Entity\ServiceOptions", mappedBy="serviceOptionDesccriptions")
     */
