 ...
 * @ORM\Entity(repositoryClass="PartyCravings\ClientAreaBundle\Repository\AffiliatesRepository")
 */
class Affiliates
{
    /**
     ...
     * @var int
     *
     * @ORM\ManyToOne(targetEntity="PartyCravings\ClientAreaBundle\Entity\Agency", inversedBy="affliates")
    ...
    /**
    * @ORM\ManyToOne(targetEntity="PartyCravings\AccountsBundle\Entity\Accounts", inversedBy="affliates")
    * @ORM\JoinColumn(name="account_id", referencedColumnName="id")
    */
    private $accountId;
    /**
    * @ORM\OneToOne(targetEntity="PartyCravings\ClientAreaBundle\Entity\AffiliatesExtra", inversedBy="affilliateId")
