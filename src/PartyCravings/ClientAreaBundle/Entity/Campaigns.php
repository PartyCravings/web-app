 ...
 * @ORM\Entity(repositoryClass="PartyCravings\ClientAreaBundle\Repository\CampaignsRepository")
 */
class Campaigns
{
    /**
     ...
     * @var string
     *
     * @ORM\ManyToOne(targetEntity="PartyCravings\ClientAreaBundle\Entity\CampaignAttachments", inversedBy="campaignId")
