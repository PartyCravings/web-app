 ...
 * @ORM\Entity(repositoryClass="PartyCravings\ClientAreaBundle\Repository\serviceOptionsRepository")
 */
class ServiceOptions
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="PartyCravings\ClientAreaBundle\Entity\ServiceOptionDescriptions", inversedBy="serviceOptionId")
