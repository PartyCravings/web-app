 ...
 * @ORM\Entity(repositoryClass="PartyCravings\ClientAreaBundle\Repository\AffiliatesExtraRepository")
 */
class AffiliatesExtra
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="PartyCravings\ClientAreaBundle\Entity\Affiliates", mappedBy="affiliatesExtra")
     */
