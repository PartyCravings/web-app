 ...
 * @ORM\Entity(repositoryClass="PartyCravings\ClientAreaBundle\Repository\TaxRatesRepository")
 */
class TaxRates
{
    /**
     ...
     * @var int
     *
     * @ORM\OneToOne(targetEntity="PartyCravings\ClientAreaBundle\Entity\TaxRateDescriptions", inversedBy="taxRateId")
