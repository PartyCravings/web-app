 ...
 * @ORM\Entity(repositoryClass="PartyCravings\ClientAreaBundle\Repository\EventsRepository")
 */
class Events
{
    /**
    ...
    /**
     * @ORM\OneToOne(targetEntity="PartyCravings\ClientAreaBundle\Entity\EventsToMedia", inversedBy="eventId")
     * @ORM\JoinColumn(name="eventsToMedia", referencedColumnName="id")
     */
    private $eventMedia;

    /**
     * @ORM\OneToOne(targetEntity="PartyCravings\ClientAreaBundle\Entity\EventsData", inversedBy="eventId")
