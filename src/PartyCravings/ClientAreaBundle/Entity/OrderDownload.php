 ...
 * @ORM\Entity(repositoryClass="PartyCravings\ClientAreaBundle\Repository\OrderDownloadRepository")
 */
class OrderDownload
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="PartyCravings\ClientAreaBundle\Entity\OrderDownloadHistory", mappedBy="orderDownloadId")
     */
