 ...
 * @ORM\Entity(repositoryClass="PartyCravings\ClientAreaBundle\Repository\ManufacturersRepository")
 */
class Manufacturers
{
    /**
    ...
    /**
    * @ORM\OneToMany(targetEntity="PartyCravings\ClientAreaBundle\Entity\AsoEbi", mappedBy="manufacturerId")
    */
    private $asoEbi;
