 ...
 * @ORM\Entity(repositoryClass="PartyCravings\ClientAreaBundle\Repository\AsoEbiRepository")
 */
class AsoEbi
{
    /**
     ...
     * @var int
     *
     * @ORM\ManyToOne(targetEntity="PartyCravings\ClientAreaBundle\Entity\Manufacturers", inversedBy="asoEbi")
     ...
     * @var int
     *
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Language", inversedBy="asoEbi")
