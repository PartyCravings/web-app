 ...
 * @ORM\Entity(repositoryClass="PartyCravings\ClientAreaBundle\Repository\BillingCategoriesRepository")
 */
class BillingCategories
{
     ...
     * @var int
     *
     * @ORM\OneToMany(targetEntity="PartyCravings\ClientAreaBundle\Entity\Billings", mappedBy="billingCategory")
     */
    private $billingId;
    ...
    {
        $this->billingId = new ArrayCollection();
    }
