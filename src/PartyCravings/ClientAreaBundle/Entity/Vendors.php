 ...
 * @ORM\Entity(repositoryClass="PartyCravings\ClientAreaBundle\Repository\VendorsRepository")
 */
class Vendors
{
    /**
    ...
    /**
     * @ORM\OneToOne(targetEntity="PartyCravings\ClientAreaBundle\Entity\VendorDescriptons", inversedBy="vendorId")
