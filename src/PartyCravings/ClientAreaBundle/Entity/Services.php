 ...
 * @ORM\Entity(repositoryClass="PartyCravings\ClientAreaBundle\Repository\servicesRepository")
 */
class Services
{
    /**
    ...
    /**
     * @ORM\OneToOne(targetEntity="PartyCravings\ClientAreaBundle\Entity\ServiceDescriptions", inversedBy="serviceId")
    */
