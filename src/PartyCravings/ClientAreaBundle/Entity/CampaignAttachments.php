 ...
 * @ORM\Entity(repositoryClass="PartyCravings\ClientAreaBundle\Repository\CampaignAttachmentsRepository")
 */
class CampaignAttachments
{
     ...
     * @var int
     *
     * @ORM\OneToMany(targetEntity="PartyCravings\ClientAreaBundle\Entity\Campaigns", mappedBy="attachments")
     */
    private $campaignId;
