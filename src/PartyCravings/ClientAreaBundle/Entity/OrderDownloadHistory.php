 ...
 * @ORM\Entity(repositoryClass="PartyCravings\ClientAreaBundle\Repository\OrderDownloadHistoryRepository")
 */
class OrderDownloadHistory
{
     ...
     * @var int
     *
     * @ORM\ManyToOne(targetEntity="PartyCravings\ClientAreaBundle\Entity\OrderDownload", inversedBy="orderDownloadHistory")
