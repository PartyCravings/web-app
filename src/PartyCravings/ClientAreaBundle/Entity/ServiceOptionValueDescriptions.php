 ...
 * @ORM\Entity(repositoryClass="PartyCravings\ClientAreaBundle\Repository\serviceOptionValueDescriptionsRepository")
 */
class ServiceOptionValueDescriptions
{
     ...
     * @var int
     *
     * @ORM\OneToOne(targetEntity="PartyCravings\ClientAreaBundle\Entity\ServiceOptionValues", mappedBy="serviceOptionValueDescriptions")
     */
