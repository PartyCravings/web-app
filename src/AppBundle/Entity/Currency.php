...
class Currency
{
     ...
     * @var string
     *
     * @Assert\NotBlank(message="currency.name.blank")
     ...
     * @var string
     *
     * @Assert\NotBlank(message="currency.symbol.blank")
     ...
     * @var int
     *
     * @Assert\NotBlank(message="currency.rate.blank")
    ...
    {
        return $this->symbol ?: $this->isoCode;
    }
