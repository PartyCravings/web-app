 ...
 * @ORM\Entity(repositoryClass="AppBundle\Repository\serviceOptionValuesRepository")
 */
class ServiceOptionValues
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="ServiceOptionValueDescriptions", inversedBy="serviceOptionValues")
