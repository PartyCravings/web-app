...
class BlogController extends AbstractController
{
     ...
     *
     * NOTE: The ParamConverter mAppBundleing is required because the route parameter
    ...
    public function commentNewAction(Request $request, Post $post, EventDispatcherInterface $eventDispatcher): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            // For simple AppBundlelications, use the GenericEvent object provided by Symfony
            // to pass some PHP variables. For more complex AppBundlelications, define your
